...
<!--  공통적으로사용할 라이브러리 추가 ; 순서 지켜줘야함 jquery로 적어주니깐 먼저, 그다음 하위 라이브러리들 추가-->
<!-- Jquery 라이브러리 -->
	...
	<div id="header">
      <div id="header_1">
         <div id="header_1_left">
            <img src="https://www.iei.or.kr/resources/images/main/main_renewal/top_logo.jpg" style="width:80%;" />
         </div>
